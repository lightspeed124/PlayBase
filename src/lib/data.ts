...
export const rentalItems: RentalItem[] = [
  ...
  // ─── KIDZZ STAR JUMPERS — additional items from live site ─────────────────

  {
    id: "toy-story-jumper",
    companyId: "kidzz-star-jumpers",
    name: "Toy Story Jumper",
    slug: "toy-story-jumper",
    category: "Bounce Houses",
    themes: ["Toy Story", "Disney", "Pixar", "Adventure"],
    description:
      "Bring the magic of Toy Story to life with this colorful themed bounce house! Featuring Woody, Buzz Lightyear, and the whole Toy Story gang on bright, vibrant artwork. Kids will love bouncing in this spacious inflatable with safety netting on all sides and an interior basketball hoop.",
    dimensions: "13ft x 13ft x 14ft",
    capacity: 6,
    ageRange: "2–12 years",
    setupTime: 25,
    ...
    available: true,
    features: [
      "Toy Story themed artwork",
      "Safety netting on all sides",
      "Interior basketball hoop",
      "Easy entry ramp",
      "Cleaned & sanitized before every rental",
    ],
    safetyNotes: "Maximum 5–6 kids of equal size. Adult supervision required at all times.",
    colors: ["Blue", "Yellow", "Green"],
  },

  {
    id: "razzle-dazzle-castle-modular",
    companyId: "kidzz-star-jumpers",
    name: "Razzle Dazzle Castle Modular",
    slug: "razzle-dazzle-castle-modular",
    category: "Bounce Houses",
    themes: ["Princess", "Castle", "Fantasy"],
    description:
      "A modular castle bounce house with interchangeable themed banners — choose your princess theme! Features a spacious bouncing area, safety netting on all sides, entry ramp, and a basketball hoop inside. The modular banner system lets you personalize the theme to match your party.",
    dimensions: "15ft x 15ft x 14ft",
    capacity: 6,
    ageRange: "2–12 years",
    setupTime: 30,
  ...
  {
    id: "4in1-side-slide-combo",
    companyId: "kidzz-star-jumpers",
    name: "4-in-1 Side Slide Combo",
    slug: "4in1-side-slide-combo",
    category: "Combos",
    themes: ["Adventure", "Multi", "Sports"],
    description:
      "A versatile 4-in-1 combo unit featuring a bounce area, side slide, climbing wall, and obstacle section. Perfect for parties where you want maximum entertainment from a single unit. The side-exit slide design keeps the flow of kids moving safely.",
    dimensions: "20ft x 15ft x 14ft",
    capacity: 8,
    ageRange: "3–14 years",
    setupTime: 45,
    ...
    safetyNotes: "One person on the slide at a time. Maximum weight per climber 150 lbs.",
    colors: ["Blue", "Red", "Yellow"],
  },

  {
    ...
    category: "Concessions",
    themes: ["Concessions", "Food", "Summer", "Carnival"],
    description:
      "Keep guests cool with fresh snow cones! Our commercial-grade snow cone machine shaves ice fast and comes with 50 servings of flavored syrup in assorted flavors. Easy plug-and-go operation — perfect for summer parties, school events, and carnivals.",
    dimensions: "18in x 18in x 24in",
    capacity: 0,
    ageRange: "All ages",
    setupTime: 10,
    price: 99,
    ...
    available: true,
    features: [
      "Commercial-grade shaver",
      "50 servings included",
      "Assorted syrup flavors",
      "Easy plug-and-go operation",
    ],
    safetyNotes: "Keep away from children under 3. Adult operation recommended.",
    colors: ["White", "Red"],
  },

  {
    id: "bubble-machine-stand",
    companyId: "kidzz-star-jumpers",
    name: "Bubble Machine with Stand",
    slug: "bubble-machine-with-stand",
    category: "Concessions",
    themes: ["Concessions", "Fun", "Kids"],
    description:
      "Add a magical touch to any party with our bubble machine! Continuously produces hundreds of bubbles per minute. Mounted on a stand for optimal bubble coverage. Kids of all ages love it — perfect as a fun accent to any outdoor event.",
    dimensions: "12in x 12in x 48in (with stand)",
    capacity: 0,
    ageRange: "All ages",
    setupTime: 5,
    price: 89,
    ...
    available: true,
    features: [
      "Continuous bubble output",
      "Stand included",
      "Easy plug-and-go",
      "Bubble solution included",
    ],
    safetyNotes: "Wet surfaces can be slippery. Keep away from electrical hazards.",
    colors: ["White"],
  },

  {
    id: "connect-4-game",
    companyId: "kidzz-star-jumpers",
    name: "Connect 4 (Giant)",
    slug: "connect-4-giant",
    category: "Games",
    themes: ["Games", "Carnival", "Competition"],
    description:
      "Giant-sized Connect 4 game — a crowd-pleasing classic scaled up for outdoor events! Drop the oversized discs and try to connect four in a row before your opponent. Great for all ages at school carnivals, corporate picnics, and backyard parties.",
    dimensions: "3.5ft x 2ft x 4ft",
    capacity: 2,
    ageRange: "All ages",
    setupTime: 10,
    price: 65,
    ...
    available: true,
    features: [
      "Giant oversized game",
      "Easy setup",
      "Durable plastic pieces",
    ],
    safetyNotes: "Pieces may be a choking hazard for children under 3.",
...

  {
    ...
    slug: "corn-hole",
    category: "Games",
    themes: ["Games", "Outdoor", "BBQ", "Competition"],
    description:
      "Classic corn hole (bean bag toss) boards for your event! Set includes two boards and 8 bean bags (4 per team). Great for all ages and perfect at BBQs, tailgates, school events, and backyard parties. Easy to set up and transport.",
    dimensions: "4ft x 2ft per board",
    capacity: 4,
    ageRange: "All ages",
    setupTime: 5,
    price: 65,
    ...
    safetyNotes: "Keep playing area clear of bystanders.",
    colors: ["Natural Wood"],
  },

  {
    ...
    slug: "food-warmer",
    category: "Concessions",
    themes: ["Concessions", "Food", "Events"],
    description:
      "Keep food warm and ready to serve at your event with our commercial food warmer. Perfect for large gatherings where food needs to stay at a safe serving temperature. Compatible with standard food pans (not included).",
    dimensions: "24in x 16in x 14in",
    capacity: 0,
    ageRange: "All ages",
    setupTime: 10,
    price: 79,
    ...
    features: [
      ...
      "Standard pan compatible",
    ],
    safetyNotes: "Adult operation only. Keep away from flammable materials.",
    colors: ["Silver", "Black"],
  },

  {
    id: "generator-4500w",
    companyId: "kidzz-star-jumpers",
    name: "Generator (4500W / 5500W)",
    slug: "generator-4500w-5500w",
    category: "Tables & Chairs",
    themes: ["Equipment", "Power", "Events"],
    description:
      "Need power at a location without electrical access? Our generator rental provides reliable 4500W–5500W of power — enough to run one or two inflatables simultaneously. Perfect for park events, open fields, and locations without outlets.",
    dimensions: "24in x 18in x 20in",
    capacity: 0,
    ageRange: "All ages",
    setupTime: 15,
    price: 98,
    ...
    features: [
      "4500W–5500W output",
      "Powers 1–2 inflatables",
      "Fuel not included",
      "Extension cord included",
    ],
    safetyNotes: "Operate outdoors only. Keep away from inflatables and children. Propane/gas not included.",
    colors: ["Orange", "Black"],
  },
